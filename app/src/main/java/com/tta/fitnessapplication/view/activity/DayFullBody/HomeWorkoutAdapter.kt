...
class HomeWorkoutAdapter : RecyclerView.Adapter<HomeWorkoutAdapter.HomeWorkoutAdapterViewHolder>() {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): HomeWorkoutAdapterViewHolder {
        val inflater = LayoutInflater.from(parent.context)
        val binding = LayoutItemHomeworkoutBinding.inflate(inflater, parent, false)
        return HomeWorkoutAdapterViewHolder(binding)
    }

    override fun onBindViewHolder(holder: HomeWorkoutAdapterViewHolder, position: Int) {
    ...
    class HomeWorkoutAdapterViewHolder(
